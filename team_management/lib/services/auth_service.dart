...
class AuthService {
  ...
  getProfileImage() {
    if(_firebaseAuth.currentUser!.photoURL != null) {
      return Image.network(_firebaseAuth.currentUser!.photoURL.toString(), height: 100, width: 100);
    } else {
  ...
  Future<String> createUserWithEmailAndPassword(
    ...
    // Update the username
    await updateUserName(name, authResult.user as User);
  ...
  Future convertWithGoogle() async {
    ...
    await currentUser!.linkWithCredential(credential);
    await updateUserName(_googleSignIn.currentUser!.displayName.toString(), currentUser);
  }
